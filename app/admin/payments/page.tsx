  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Transaction <span className="text-luxe-primary">Ledger</span></h1>
          <p className="text-luxe-on-surface-variant text-sm mt-1">Audit and regulate financial flows.</p>
        </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between px-8 py-5 border-t border-luxe-outline-variant/10 bg-luxe-surface-container/20">
                  <div className="flex items-center gap-4 text-[10px] font-bold text-luxe-on-surface-variant uppercase tracking-widest">
                    ...
                    <span className="px-2 py-0.5 rounded bg-luxe-primary/10 text-luxe-primary">{payments.length} Records</span>
                  </div>
